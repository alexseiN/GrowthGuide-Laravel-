...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Growth Guide-Legal Services</title>
      ...
      <div class="row gx-0 align-items-center">
        ...
        <div class="col-lg-5 px-5 text-end">
          <div class="h-100 d-inline-flex align-items-center">
            <a class="text-white-50 ms-4" href="">Login</a>
    ...
    >
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
          ...
          <div class="nav-item dropdown {{$category->category_name}}">
            <a
              href="#"
              class="nav-link dropdown-toggle"
              data-bs-toggle="{{$category->category_name}}"
              >{{$category->category_name}}</a
            >
            <div class="dropdown-menu bg-light border-0 m-0">
            @foreach($services as $service)
                @if($category->id==$service->category_id)
              {{-- <a href="feature.html" class="dropdown-item">{{$service->service_name}}</a> --}}
              <a href="/show-form/{{ $service->id }}" class="dropdown-item">{{$service->service_name}}</a>
            @endif
              @endforeach
            </div>
          </div>
      ...
      <a href="" class="btn btn-primary px-3 d-none d-lg-block">Our Company</a>
    </nav>
    <!-- Navbar End -->
      ...
      <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="w-100"  src="img/legal1.jpg"  alt="Image" />
          ...
          <div class="carousel-item">
            <img class="w-100" src="img/legal2.jpg"  alt="Image" />
            <div class="carousel-caption">
              <div class="container">
                <div class="row">
                  <div class="col-12 col-lg-6">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
              &copy; <a href="#">Growth Guide</a>, All Right Reserved.
            </div>
            <div class="col-md-6 text-center text-md-end">
              <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
              Designed By <a href="https://htmlcodex.com">Shivam</a>
              <br />
